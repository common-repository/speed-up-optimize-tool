...
class Speed_Up_Optimize {
	 ...
	 * @return  void
	 */
	public function __construct( $file = '', $version = '1.0.10', $pluginoptions = array() ) {
		$this->version = $version;
		$this->token   = 'speed_up_optimize';
	...
	public function construct_menu() {
		$menu_list = new Speed_Up_Optimize_Main();
		return $menu_list->appperf_register_menu();
	}
	...
	public function enqueue_scripts() {
		wp_register_script( $this->token . '-frontend', esc_url( $this->assets_url ) . 'js/frontend' . $this->script_suffix . '.js', array( 'jquery' ), $this->version, true );
	 ...
	 */
	public static function instance( $file = '', $version = '1.0.10', $pluginoptions = array() ) {
		if ( is_null( self::$instance ) ) {
			self::$instance = new self( $file, $version, $pluginoptions );
		}
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html_e( 'Cheatin&#8217; huh?', 'speed-up-optimize' ), esc_html( $this->parent->version ) );
	} // End __clone ()
